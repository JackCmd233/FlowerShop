...
<script type="text/javascript">
	...
	function  goOrderConfirm(){
		window.location.href="/FlowerShop/cart/orderConfirm";
	}
	//清空
	function godelete(){
		if(window.confirm("真的清空购物车吗？")){
			window.location.href="/FlowerShop/cart/clear";
			return true;
		}
		return false;
	}
	...
	function deleteAgoods(gno){
		if(window.confirm("真的删除该商品吗？")){
			window.location.href="/FlowerShop/cart/deleteAgoods?id=" + gno;
			return true;
		}
		return false;
	}
					...
					<tr>
						<td align="right" bgcolor="#ffffff" colspan="4" height="41px;"
							...
							<font style="color: #a60401; font-size: 13px; font-weight: bold; letter-spacing: 0px;">
								购物金额总计(含运费) ￥&nbsp;<span id="stotal"></span>
							${total}元
						</font></td>
						<td align="center" bgcolor="#ffffff">
							<input type="button" value="清空购物车" 
							onclick="godelete()" class="bnt_blue_1" id="bnt11" />
						</td>
					</tr>
					<tr>
