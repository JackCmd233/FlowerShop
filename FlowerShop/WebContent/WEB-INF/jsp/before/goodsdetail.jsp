...
<script type="text/javascript">
	...
	function gofocus(gno) {
		window.location.href = "/FlowerShop/cart/focus?id=" + gno;
	}
</script>
</head>
<body>
		...
		<div class="block clearfix">
			...
			<div id="goodsInfo">
				<div class="imgInfo">
					...
					<img src="logos/${goods.gpicture}" width="230px" height="230px" />
				</div>
			</div>
			<!--商品表述-->
			<div class="goods_desc">
				...
				<div class="goods_show">
					<ul>
						...
						<li><span>折扣价:</span><strong class="xj">${goods.grprice }元</strong></li>
				...
				<p class="bottom10 top5">
					<img src="images/before/goods_ann2.gif" style="cursor: pointer" 
						onclick="goCart()" />&nbsp;&nbsp;
					<input type="button" style="cursor: pointer" class="sh_bnt2" 
						onclick="gofocus('${goods.id }')"
						value="关注" />
				</p>${msg }
				<div>
					<span>介绍:</span> ${goods.productDesciption }
				</div>
			</div>
			<!--end-->
			</div>  
