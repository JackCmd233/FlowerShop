...
<body>
	...
	<div id="navigator">
		<ul>
			...
			<li><a>类型管理</a>
				<ul>
					<li><a href="adminType/selectGoodsType" target="center">类型详情</a></li> 
					<li><a href="adminType/toAddType" target="center">添加类型</a></li> 
					<li><a href="adminType/selectGoodsType?act=deleteSelect" target="center">删除类型</a></li>   
				</ul></li> 
			<li><a>用户管理</a>
				<ul>
					<li><a href="adminUser/userInfo" target="center">用户详情</a></li>
				</ul></li>
			<li><a>订单管理</a>
				<ul>
					<li><a href="adminOrder/orderInfo" target="center">查询订单</a></li>
				</ul></li>
			<li><a>公告管理</a>
				<ul>
