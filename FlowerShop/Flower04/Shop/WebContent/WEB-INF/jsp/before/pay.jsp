...
function pay(orderId,amount){
	...
	if(payMethod==1){
		window.location.href = "/Shop/alipay?orderId="+orderId+"&amount="+amount;	 
	}
	if(payMethod==0){
		window.location.href = "/Shop/weChatpaid/"+orderId+"/"+amount;	
	}
}
</script>
</head>
	...
	<div class="pay-main row "> s
		...
		<div class="col-md-8 col-md-offset-2" style="border: 1px solid #ccc;padding-bottom: 31px;">
			...
			<div class="col-md-4 col-md-offset-8 ">
				<button type="button" class="btn btn-danger btn-lg" onclick="pay(${orderId},${amount})">支付</button>
			</div>
		</div>
	</div>
	${amount} <br>
